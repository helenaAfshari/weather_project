...
import 'package:mini_project_bloc/features/feature_bookmark/domain/use_cases/delete_city_usecase.dart';
import 'package:mini_project_bloc/features/feature_bookmark/domain/use_cases/get_all_city_usecase.dart';
import 'package:mini_project_bloc/features/feature_weather/domain/use_cases/get_current_weather_usecase.dart';
...
setup() async {
  ...
  //این دیتابیس هست که میخواییم در پروژه ازش استفاده کنیم 
  //اینجا بیلد را انجام میدهد میسازد 
  //اینجا اسم دقیق کلاس را مینویسیم که اسمش دیتابیس هست پس میشه
  //floorAppDataBase
  final database = await $FloorAppDatabase.databaseBuilder('app_database.db').build();
  locator.registerSingleton<AppDatabase>(database);

  /// repositories
  locator.registerSingleton<WeatherRepository>(WeatherRepositoryImpl(locator()) as WeatherRepository);
