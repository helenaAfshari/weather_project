...
import 'package:mini_project_bloc/features/feature_weather/data/data_source/remote/api_provider.dart';
import 'package:mini_project_bloc/features/feature_weather/data/models/current_city_model.dart';
...
import 'package:mini_project_bloc/features/feature_weather/domain/entities/suggest_city_entity.dart';
...
class WeatherRepositoryImpl extends WeatherRepository{
 ...
 @override
  Future<List<Data>> fetchSuggestData(cityName) async {
    ...
    //اینجا چون لیستس از دیتا را میخواییم بدیم پس مینویسیم دیتاهاشو بهم بده
